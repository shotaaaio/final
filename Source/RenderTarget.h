...
public:
	...
	//シェーダーリソースビュー取得
	const Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>& GetShaderResorceView() { return shaderResorceView; }
...
private:
	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>shaderResorceView;
