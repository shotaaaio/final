...
void GameScene2::initialize()
{
	...
	hp = std::make_unique<Sprite>(deviceMgr->getDevice(), L"Resources/Image/HPgage.png");
		...
		if (ImGui::BeginTabBar("DebugTabs"))
		{
			...
			if (ImGui::BeginTabItem("2D Debug"))
			{
				if (ImGui::TreeNode("Glitch Shader"))
				{
					...
					if (ImGui::CollapsingHeader("Invert Flash", ImGuiTreeNodeFlags_DefaultOpen))
					{
						ImGui::SliderFloat("Flash Frequency", &glitchData.flash_frequency, 0.0f, 10.0f);
						ImGui::SliderFloat("Flash Strength", &glitchData.flash_strength, 0.0f, 1.0f);
					}
					...
					if (ImGui::Button("Reset All")) {
						...
						glitchData.flash_frequency = 0.0f;
						glitchData.flash_strength = 0.0f;
					}
